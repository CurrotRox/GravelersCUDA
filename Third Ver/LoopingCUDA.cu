...
#define THREADROLLS 100 // Each instance is running 100 times, so this 10 million will result in 1 billion simulations.


//Inserting xorshift32 onto device
//This is a really fast way to generate random numbres, through a lot of XOR operations, 3 standard ones and one with the clock time.
